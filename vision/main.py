...
parser.add_argument('--optim', type=str, default='adam', help='Batch size.')
...
parser.add_argument('--save_file_name_csv', type=str, default='run_1.csv')
...
#    if args.optim == 'adam':
#        print ('Using Adam...')
#        optimizer = optimizers.RiemannianAdam(net.parameters(), lr=state['learning_rate'], weight_decay=state['decay'])
